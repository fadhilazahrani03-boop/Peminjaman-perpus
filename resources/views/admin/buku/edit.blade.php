            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">                 
                <form action="{{ route('admin.buku.update', $buku->id) }}" method="POST">                     
                    ...
                    <div class="mb-4">                         
                        ...
                        <input type="text" name="judul" value="{{ $buku->judul }}" class="bordergray-300 rounded-md shadow-sm w-full" required>                     
                    </div>                     
                    <div class="mb-4">                         
                    ...
                    <div class="mb-4">                         
                        ...
                        <input type="number" name="stok" value="{{ $buku->stok }}" class="bordergray-300 rounded-md shadow-sm w-full" required>                     
                    </div>                     
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 roundedmd">Update</button>                     
